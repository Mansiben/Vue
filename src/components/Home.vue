   ...
   <section class="section">
     <div class="container">
       <div class="columns pd is-desktop">
         ...
         <div class="column is-1-3-desktop">
           <p class="title"><strong>We provide superior logistics so that your business can succeed in a crazy world.</strong></p>
         </div>
         <div class="column">
           <p>Lipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
         </div>
       </div>
     </div>
       ...
       <div class="column">
         <div class="card">
           <div class="card-content">
             ...
             <p class="subtitle">- Mansi Thakkar</p>
           </div>
         </div>
       </div>
        <div class="column">
